...
| Process-death and ambiguous recovery | `process_death_evidence` in `v10-refinement-contract.json` | exact hostile independent-process mappings cover SQLite and Git authority effects, direct and integrated post-publication committed/ambiguous effect outcomes, plus barrier recovery; implementation refinement remains not-proven |
